...
| Name | Description | Type | Default | Required |
|------|-------------|------|---------|:--------:|
| <a name="input_aws_amis"></a> [aws\_amis](#input\_aws\_amis) | n/a | `map(any)` | <pre>{<br>  "amazonlinux2": {<br>    "filters": {<br>      "architecture": [<br>        "x86_64"<br>      ],<br>      "name": [<br>        "amzn2-ami-kernel-*hvm*-gp*",<br>        "amzn2-ami-hvm*-gp*"<br>      ],<br>      "root-device-type": [<br>        "ebs"<br>      ],<br>      "virtualization-type": [<br>        "hvm"<br>      ]<br>    },<br>    "most_recent": true,<br>    "owners": [<br>      "amazon"<br>    ]<br>  },<br>  "ubuntu1804": {<br>    "filters": {<br>      "architecture": [<br>        "x86_64"<br>      ],<br>      "name": [<br>        "ubuntu-minimal/images/*/ubuntu-bionic-18.04-*"<br>      ],<br>      "root-device-type": [<br>        "ebs"<br>      ],<br>      "virtualization-type": [<br>        "hvm"<br>      ]<br>    },<br>    "most_recent": true,<br>    "owners": [<br>      "099720109477"<br>    ]<br>  },<br>  "ubuntu2004": {<br>    "filters": {<br>      "architecture": [<br>        "x86_64"<br>      ],<br>      "name": [<br>        "ubuntu/images/*/ubuntu-focal-20.04-amd64-*"<br>      ],<br>      "root-device-type": [<br>        "ebs"<br>      ],<br>      "virtualization-type": [<br>        "hvm"<br>      ]<br>    },<br>    "most_recent": true,<br>    "owners": [<br>      "099720109477"<br>    ]<br>  },<br>  "ubuntu2204": {<br>    "filters": {<br>      "architecture": [<br>        "x86_64"<br>      ],<br>      "name": [<br>        "ubuntu/images/*/ubuntu-jammy-22.04-*"<br>      ],<br>      "root-device-type": [<br>        "ebs"<br>      ],<br>      "virtualization-type": [<br>        "hvm"<br>      ]<br>    },<br>    "most_recent": true,<br>    "owners": [<br>      "099720109477"<br>    ]<br>  }<br>}</pre> | no |
